...
Update by darkbane for 18.5  Anarchy Online patch (executable changes)
...
History
-------	
2.4.1		- Fixed item icon interpolation.
     		- Fixed items not being detected in find/return-item missions with certain mission descriptions.
2.4.0		- Updated for 18.5
		Executable changed preventing old hooking.  New	hooking used via Detours
